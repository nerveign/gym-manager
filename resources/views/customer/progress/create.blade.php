...
<head>
    ...
    <title>Add Progress | Customer</title>
...
<body class="bg-gray-50 overflow-hidden">
    <div class="flex h-screen">
        ...
        <div class="flex-1 ml-64 h-screen flex flex-col">
            ...
            {{-- 1. HEADER BAR (Style sesuai referensi 'Tambah Equipment Baru') --}}
            <div class="bg-white border-b px-8 py-4 flex justify-between items-center shadow-sm shrink-0 z-20">
                <div class="flex items-center gap-4">
                    ...
                    <h1 class="text-xl font-bold text-gray-900">Tambah Progress Baru</h1>
                </div>
            </div>
            ...
            <div class="flex-1 overflow-y-auto p-8">
                <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                    ...
                    <form action="{{ route('customer.progress.store') }}" method="POST">
                        ...
                        {{-- GRID 2 KOLOM (Mirip input Nama Equipment & Brand) --}}
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       placeholder="Contoh: Lari Treadmill, Angkat Beban" required>
                                @error('exercise')
                        ...
                        {{-- FULL WIDTH: Description (Mirip input Deskripsi Lengkap) --}}
                        <div class="mb-8">
                            ...
                            <textarea name="description" 
                                      ...
                                      rows="5" 
                                      class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 shadow-sm" 
                                      placeholder="Tuliskan detail latihan, beban angkatan, atau perasaan setelah latihan...">{{ old('description') }}</textarea>
                             @error('description')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>

                        {{-- ACTION BUTTONS (Mirip tombol Batal & Simpan Data) --}}
