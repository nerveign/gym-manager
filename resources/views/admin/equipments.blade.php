        ...
        <div class="flex-1 ml-64">
            ...
            <main class="pt-4 pb-8 px-4 h-screen overflow-y-auto scroll-container">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="{{ route('admin.equipments.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition shadow-sm text-sm font-medium flex items-center gap-2">
                        ...
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    <td class="px-6 py-4">
                                        <a href="{{ route('admin.equipments.show', $equipment->id) }}" class="flex items-center group cursor-pointer">
