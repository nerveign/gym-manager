    ...
    <div class="flex h-screen">
        ...
        <div class="w-64 bg-white fixed left-0 top-0 h-full z-50 border-r">
            ...
            <nav class="mt-6">
                ...
                <x-nav-item text="Trainers" color="text-gray-600" src="user.svg" location="admin.trainers_management" style="bg-blue-50 border-r-4 border-blue-500" />
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                                            <td class="py-4">
                                                <div class="flex items-center">
                                                    ...
                                                    @endif
                                                    <div>
                                                        <a href="{{ route('admin.trainer.detail', $trainer->id) }}" class="font-medium text-gray-900 hover:text-gray-700 hover:underline transition-colors duration-200">{{ $trainer->name }}</a>
