    ...
    <div class="flex h-screen">
        ...
        <div class="w-64 bg-white fixed left-0 top-0 h-full z-50 border-r">
            ...
            <nav class="mt-6">
                ...
                <x-nav-item text="Trainer" color="text-gray-600" src="user.svg" location="admin.trainers_management" style="bg-blue-50 border-r-4 border-blue-500" />
                            ...
                            <table class="w-full">
                                ...
                                <tbody class="divide-y divide-gray-100">
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                                            <td class="py-4">
                                                <div class="flex items-center">
                                                    <img class="w-8 h-8 rounded-full mr-3" src="{{ $trainer->image_url }}" alt="John Doe">
                                                    <div>
