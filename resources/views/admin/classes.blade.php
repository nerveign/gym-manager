    ...
    <div class="flex h-screen">
        ...
        <div class="w-64 bg-white fixed left-0 top-0 h-full z-50 border-r">
            ...
            <nav class="mt-6">
                ...
                <x-nav-item text="Classes" color="text-gray-600" src="class.svg" location="admin.classes_management" style="bg-blue-50 border-r-4 border-blue-500"  />
        ...
        <div class="flex-1 ml-64">
            ...
            <main class="pt-4 pb-8 px-4 h-screen overflow-y-auto scroll-container">
                <h2 class="text-2xl font-bold text-gray-900 mb-6">Classes Management</h2>
            </main>
        </div>
    </div>
</body>
