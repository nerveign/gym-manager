...
<body class="bg-gray-100">
    <div class="flex h-screen">
        ...
        <div class="w-64 bg-white fixed left-0 top-0 h-full z-50 border-r flex flex-col">
            ...
            {{-- Header Sidebar (DIPERBAIKI AGAR SESUAI PROFIL) --}}
            {{-- Menggunakan komponen x-dashboard-header agar konsisten dengan halaman profil --}}
                    ...
                    <div class="divide-y divide-gray-100">
                        ...
                        @empty
                            <div class="p-12 text-center">
                                ...
                                <p class="text-gray-500 text-sm mt-1">Your upcoming scheduled sessions will appear here.</p>
                            </div>
                        @endforelse
                    </div>
                </div>
