...
<head>
    ...
    <title>Detail Equipment | Trainer</title>
    ...
    <div class="flex h-screen">
        ...
        <x-trainer-sidebar activeMenu="equipment" />
            ...
            <nav class="mt-6 flex-1 overflow-y-auto">
                ...
                <div class="px-4 py-2 text-xs font-medium text-zinc-400 mt-4">Fasilitas</div>
            ...
            <div class="p-4 border-t bg-white flex-shrink-0">
                <div class="flex items-center justify-between">
                    <a href="{{ route('trainer.profile.edit') }}" class="flex items-center flex-1 hover:bg-gray-50 rounded-lg p-2 transition-colors group">
                        @if($user->image_url)
                        <img class="w-8 h-8 rounded-full object-cover border border-gray-200" src="{{ $user->image_url }}" alt="{{ $user->name }}">
                        @else
                        ...
                        <div class="ml-3 overflow-hidden">
                            <p class="text-sm font-medium text-gray-700 truncate group-hover:text-indigo-600 transition-colors">{{ $user->name }}</p>
                            <p class="text-xs text-gray-500 capitalize">Trainer</p>
                        </div>
                    </a>
        ...
        <div class="flex-1 ml-64 h-screen flex flex-col">
            ...
            <div class="bg-white border-b px-8 py-4 flex justify-between items-center shadow-sm shrink-0 z-20">
                <div class="flex items-center gap-4">
                    {{-- Tombol Kembali ke List Equipment Trainer --}}
                    <a href="{{ route('trainer.equipments.index') }}" class="w-9 h-9 flex items-center justify-center bg-white border border-gray-200 rounded-lg text-gray-500 hover:bg-gray-50 hover:text-indigo-600 transition shadow-sm">
